...
##### 11/26
练习四的两个 Checkpoint 基本是照着视频回放写的...  
思来想去, 还是决定弃坑了. 对 Linux 的了解太少, 而且时间也不太够, 遇到问题基本上就是 feel overwhelmed. 以后有机会再参与一次吧.  

##### 11/24
练习三, 开始填代码了. 前面四个 Checkpoint 简单, 最后一个因为没有编辑器提示, 所以类型什么的拿不准.  

搞了一下 clangd 和 rust-analyzer 的提示, 结果不知道为什么 QEMU 就挂了, 反复重新尝试编译了好几次...  
总之练习三暂且是先写完了, 希望明天能写完练习四🙏  

#### 第二周 (11/13 ~ 11/19)

##### 11/19
可能是直接编译进内核了吧, 在启动的时候能看到.  
那这样的话实验二完成.  
...
##### 11/22
第七章问答题完成.  
第八章的内容看了一下, 现在线程变成调度的最小单位了. 但是下一个线程如果不属于当前进程会发生什么 Guide 里没写, 有一点疑惑.  
实验写了一点, 我的设想有点复杂, 参考实现应该不会像我写这么复杂吧...  
